...
namespace Youtube {
    ...
    class Playlist : public VideoList {
     public:
        ...
        inline const std::string GetChannelId() const { return Check(GetStatus()) ? GetItem()["snippet"]["channelId"] : ""; }
        inline const std::string GetPlaylistId() const override { return GetId(); };
